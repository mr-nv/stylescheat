...
// Generated with polynomial 0xEDB88320L.
...
CRC32 CRC32_Get(void* pAddr, DWORD dwLength) 
{
	PBYTE pszAddr;
	DWORD dwCRC32;
	...
	for (DWORD i = 0; i < dwLength; i++)
		dwCRC32 = ((dwCRC32 >> 8) & 0x00FFFFFF) ^ g_dwCRC32Table[(dwCRC32 ^ *pszAddr++) & 0xFF];
	
	return (dwCRC32 ^ 0xFFFFFFFF);
}

CRC32 CRC32_Byte(CRC32 crc, BYTE byte)
{
	crc = ((crc >> 8) & 0x00FFFFFF) ^ g_dwCRC32Table[(crc ^ byte) & 0xFF];
